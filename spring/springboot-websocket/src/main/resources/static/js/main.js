...
var toUsernameInput = document.querySelector('#tousername');
...
function sendMessage(event) {
    ...
    var toUsername = toUsernameInput.value.trim();
    ...
    if(messageContent && stompClient) {
        ...
        if(toUsername){
            chatMessage.receiver = toUsername;
...
function onPrivateMessageReceived(payload) {
    alert("onPrivateMessageReceived:"+payload);
}
