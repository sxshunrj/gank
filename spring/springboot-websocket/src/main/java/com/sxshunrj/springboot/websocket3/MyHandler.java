...
public class MyHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        if (userId != null) {
            ...
            session.sendMessage(new TextMessage("欢迎"+userId+"登录"));
        }
        System.out.println("成功建立连接,userId:"+userId+",session:"+session);
    }
    ...
    public void forceExit(Integer userId){
        sendMessageToUser(userId, new TextMessage("你被强制下线了！"));
        users.remove(userId);
    }
